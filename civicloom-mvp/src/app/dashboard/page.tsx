    ...
    <main className="bg-slate-50 px-6 py-12">
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[.18em] text-cyan-700">Workspace</p>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Your market reports</h1>
          ...
          {reports.length ? (
            reports.map((report) => (
              <Link
                ...
                key={report.id}
                className="grid gap-2 border-b px-6 py-5 last:border-0 hover:bg-slate-50 sm:grid-cols-[1.5fr_1fr_.7fr_.7fr] sm:items-center sm:gap-4"
              >
                ...
                <span className="font-semibold text-cyan-700">{report.opportunityScore}/100</span>
            ...
            <div className="px-6 py-12 text-center">
              ...
              <Button asChild className="mt-5 bg-slate-950">
